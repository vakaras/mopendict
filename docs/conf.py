...
latex_documents = [
  (
      'index', 'main.tex',
      u'\\mopendict Documentation', u'\\Vytautas Astrauskas', 'manual'
      ),
  ]
...
man_pages = [
    (
        'index', 'main',
        u'mopendict Documentation', [u'Vytautas Astrauskas'], 1,
        ),
    ]
...
pdf_documents = [
    (
        'index', u'main',
        u'mopendict Documentation', u'Vytautas Astrauskas'
        ),
    ]
